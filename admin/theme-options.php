...
$of_options[] = array( "name" => "Number of recent post items display per slide",
					"desc" => "Select how many recent post items display per slide",
...
$of_options[] = array( "name" => "Woocomerce setting for home page",
                    "type" => "innerheading");		

$of_options[] = array( "name" =>  "Category type for Woocommerce",
...
$of_options[] = array( "name" => "Display add to cart animation",
					"desc" => "Check if you wish animation when add to cart is clicked",
					"id" => "add_to_cart",
					"std" => 1,
					"type" => "checkbox");						

$of_options[] = array( "name" => "Display recent Products?",
					"desc" => "Check this if you wish to display recent Products (under the 3 featured items).",
					"id" => "racent_status_product",
					"std" => 1,
					"type" => "checkbox");		
					
$of_options[] = array( "name" => "Number of recent Products on home page",
...
$of_options[] = array( "name" => "Number of Products items display per slide",
...
$of_options[] = array( "name" => "Display Feautured Products?",
					"desc" => "Check this if you wish to display Feautured Products on Home page (under the 3 featured items).",
					"id" => "racent_status_productF",
					"std" => 1,
					"type" => "checkbox");		
															
$of_options[] = array( "name" => "Number of feautured Products on home page",
...
$of_options[] = array( "name" => "Number of feautured Products items display per slide",
...
$of_options[] = array( "name" => "Number of Products per page in Shop",
...
$of_options[] = array( "name" => "WooCommerce Text",
                    "type" => "innerheading");		

$of_options[] = array( "name" => "Cart",
                    "desc" => "Translation for cart text.",
                    "id" => "translation_cart",
                    "std" => __('Cart','wp-emporium'),
                    "type" => "text");	
	

$of_options[] = array( "name" => "Share this product title",
                    "desc" => "Translation for Share this product title.",
                    "id" => "translation_share_product",
                    "std" =>  __('<span>Share</span> this product','wp-emporium'),
                    "type" => "text");	

$of_options[] = array( "name" => "Also like product",
                    "desc" => "Translation for Also like product title.",
                    "id" => "translation_also_like",
                    "std" => __('<span>Also</span> like','wp-emporium'),
                    "type" => "text");			

$of_options[] = array( "name" => "Login / Register",
                    "desc" => "Translation for Login / Register.",
                    "id" => "translation_login_register",
                    "std" => __('Login / Register','wp-emporium'),
                    "type" => "text");	

$of_options[] = array( "name" => "Our Futured Products",
                    "desc" => "Translation for Our futured products text.",
                    "id" => "translation_featured",
                    "std" => __('Our Futured Products','wp-emporium'),
                    "type" => "text");	
					
$of_options[] = array( "name" => "Recent Products",
                    "desc" => "Translation for Home page Recebt product title.",
                    "id" => "translation_recent_pruduct_title",
                    "std" => __('Recent Products','wp-emporium'),
                    "type" => "text");						
...
$of_options[] = array( "name" => "Quote text",
					...
					"id" => "infotext",
					"std" => __('Welcome to <span>emporium</span> - A Minimal Business Theme','wp-emporium'),
					"type" => "textarea"); 
...
$of_options[] = array( "name" => "Featured Box 1 Title",
					...
					"id" => "box1_title",
					"std" => __('Featured Box 1 Title','wp-emporium'),
					"type" => "text"); 						
...
$of_options[] = array( "name" => "Featured Box 1 description",
					...
					"id" => "box1_description",
					"std" => __('Featured Box 1 Description','wp-emporium'),
					"type" => "textarea");
...
$of_options[] = array( "name" => "Featured Box 2 Title",
					...
					"id" => "box2_title",
					"std" => __('Featured Box 2 Title','wp-emporium'),
					"type" => "text"); 						
...
$of_options[] = array( "name" => "Featured Box 2 description",
					"desc" => "Set the description text for you featured box.",
					"id" => "box2_description",
					"std" => __('Featured Box 2 Description','wp-emporium'),
					"type" => "textarea");
...
$of_options[] = array( "name" => "Featured Box 3 description",
					"desc" => "Set the description text for you featured box.",
					"id" => "box3_description",
					"std" => __('Featured Box 3 Description','wp-emporium'),
					"type" => "textarea");
...
$of_options[] = array( "name" => "Custom Logo",
					...
					"id" => "logo",
					"std" => "http://emporium.premiumcoding.com/wp-content/uploads/2012/10/logo-emporium4.png",
					"type" => "upload");
...
$of_options[] = array( "name" => "Header and footer background pattern",
                    "type" => "innerheading");					
...
$of_options[] = array( "name" => "Background header and footer Pattern",
					"desc" => "Background header and footer Pattern. To add more patterns upload them to your Theme's /images/bg-header folder.",
					"id" => "header_bg",
...
$of_options[] = array( "name" => "404 Error page Title Content Text",
                    ...
                    "id" => "errorpage",
                    "std" => __('Sorry, but the page you are looking for has not been found.<br/>Try checking the URL for errors, then hit refresh.</br>Or you can simply click the icon below and go home:)','wp-emporium'),
                    "type" => "textarea");	   	
...
$of_options[] = array( "name" => "Copyright info",
                    ...
                    "id" => "copyright",
                    "std" => __('&copy; 2011 All rights reserved. ','wp-emporium'),
                    "type" => "textarea");	
...
$of_options[] = array( "name" => "Email icon alt text",
                    ...
                    "std" => __('Send us Email','wp-emporium'),
                    "type" => "text");	
...
$of_options[] = array( "name" => "Home page Our major brands",
                    ...
                    "std" => __('Our major brands','wp-emporium'),
                    "type" => "text");	
...
$of_options[] = array( "name" => "Share category post",
                    ...
                    "std" => __('Share','wp-emporium'),
                    "type" => "text");		

$of_options[] = array( "name" => "Blog page title",
                    "desc" => "Translation for Blog page title.",
                    "id" => "translation_blog_page",
                    "std" => __('Welcome to <span>our blog</span>, we will keep you informed','wp-emporium'),
                    "type" => "text");					
...
$of_options[] = array( "name" => "Leave a Reply text",
                    ...
                    "std" => __('Leave a Reply','wp-emporium'),
                    "type" => "text");	
...
$of_options[] = array( "name" => "Leave a Reply to text",
                    ...
                    "std" => __('Leave a Reply to','wp-emporium'),
                    "type" => "text");		
