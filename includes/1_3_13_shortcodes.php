...
if($tab['link'] != '')
$content .= '<a href="'.$tab['link'] .'"><img style="height:'.$tab['height'].'px;width:'.$tab['width'].'px" src="'. get_template_directory_uri() .'/createthumb.php?path='. $tab['imageurl'] .'&amp;height='.$tab['height'].'&amp;width='.$tab['width'].'" title="'. stripText($tab['title']) .'" rel="'. get_template_directory_uri() .'/createthumb.php?path='. $tab['imageurl'] .'&amp;height=65&amp;width=110"></a>';
else
$content .= '<img style="height:'.$tab['height'].'px;width:'.$tab['width'].'px" src="'. get_template_directory_uri() .'/createthumb.php?path='. $tab['imageurl'] .'&amp;height='.$tab['height'].'&amp;width='.$tab['width'].'" title="'. stripText($tab['title']) .'" rel="'. get_template_directory_uri() .'/createthumb.php?path='. $tab['imageurl'] .'&amp;height=65&amp;width=110">';
...
if($tab['link'] != '')
$content .= '<a href="'.$tab['link'] .'"><img style="height:'.$tab['height'].'px;width:'.$tab['width'].'px" src="'. get_template_directory_uri() .'/createthumb.php?path='. $tab['imageurl'] .'&amp;height='.$tab['height'].'&amp;width='.$tab['width'].'" title="'. stripText($tab['title']) .'"></a>';
else
$content .= '<img style="height:'.$tab['height'].'px;width:'.$tab['width'].'px" src="'. get_template_directory_uri() .'/createthumb.php?path='. $tab['imageurl'] .'&amp;height='.$tab['height'].'&amp;width='.$tab['width'].'" title="'. stripText($tab['title']) .'">';


}
$return = "<script>jQuery(document).ready(function () {jQuery('.nivoSlider').nivoSlider({effect:'".$data['effect'] ."', // Specify sets like: 'fold,fade,sliceDown'slices:". $data['slices'] .", // For slice animations
        boxCols: ". $data['boxcols'] .", // For box animations
        boxRows: ". $data['boxrows'] .", // For box animations
        animSpeed:". $data['anispeed'] .", // Slide transition speed
        pauseTime:". $data['pausetime'].", // How long each slide will show
