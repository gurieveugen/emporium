...
function pagenavi_init() {
	...
	$pagenavi_options = array(
		'pages_text' => __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','wp-emporium'),
		'current_text' => '%PAGE_NUMBER%',
		'page_text' => '%PAGE_NUMBER%',
		'first_text' => __('&laquo; First','wp-emporium'),
		'last_text' => __('Last &raquo;','wp-emporium'),
		'next_text' => __('&raquo;','wp-emporium'),
		'prev_text' => __('&laquo;','wp-emporium'),
		'dotright_text' => __('...','wp-emporium'),
		'dotleft_text' => __('...','wp-emporium'),
		'style' => 1,
		'num_pages' => 5,
		'always_show' => 0,
