...
add_action( 'widgets_init', 'WooCommerce_widget_best_sellers_Custom_widget' );

function WooCommerce_widget_best_sellers_Custom_widget() {
	register_widget( 'WooCommerce_widget_best_sellers_Custom' );
}

class WooCommerce_widget_best_sellers_Custom extends WP_Widget {
	 ...
	 * @return void
	 */
	function WooCommerce_widget_best_sellers_Custom() {

		/* Widget variable settings. */
		$this->woo_widget_cssclass = 'widget_best_sellers_custom';
		...
		$this->woo_widget_name = __('Emporium Best Sellers', 'woocommerce' );
	...
	function widget( $args, $instance ) {
		...
		$cache = wp_cache_get('widget_best_sellers_custom', 'widget');
...
<?php
		...
		wp_cache_set('widget_best_sellers_custom', $cache, 'widget');
	}
	...
	function update( $new_instance, $old_instance ) {
		...
		if ( isset($alloptions['widget_best_sellers_custom']) ) delete_option('widget_best_sellers_custom');
	...
	function flush_widget_cache() {
		wp_cache_delete( 'widget_best_sellers_custom', 'widget' );
	}
