...
class recent_posts extends WP_Widget {
	function recent_posts() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'recent_posts', 'description' => 'Displays the post image and excerpt from a selected category **Does not work on singlepost sidebar**'.'wp-emporium' );



		/* Create the widget. */
		$this->WP_Widget( 'recent_posts-widget', __('Emporium Recent Posts Widget', 'wp-emporium'), $widget_ops, '' );
	}
	...
	?>			
	<!--<img src="<?php// echo get_template_directory_uri() ?>/js/timthumb.php?src=<?php// echo $image ?>&amp;h=55&amp;w=85" alt="<?php// the_title(); ?>"> -->
	<div class="imgholder"><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title(); ?>"><img src="<?php echo get_template_directory_uri() ?>/createthumb.php?path=<?php echo $image ?>&amp;height=55&amp;width=85" alt="<?php the_title(); ?>"></a></div>
