...
add_action( 'widgets_init', 'WooCommerce_widget_price_filter_Custom_widget' );



function WooCommerce_widget_price_filter_Custom_widget() {
	register_widget( 'WooCommerce_widget_price_filter_Custom' );
}

class WooCommerce_widget_price_filter_Custom extends WP_Widget {
	 ...
	 * @return void
	 */
	function WooCommerce_widget_price_filter_Custom() {

		/* Widget variable settings. */
		$this->woo_widget_cssclass = 'widget_price_filter_custom';
		...
		$this->woo_widget_idbase = 'woocommerce_price_filter_custom';
		$this->woo_widget_name = __('Emporium Price Filter', 'woocommerce' );
		...
		echo '<form method="get" action="' . $form_action . '">
			<div class="price_slider_wrapper">
				...
				<div class="price_slider_amount">
					...
					if(isset($_GET['shop'])){
					echo '<input type="hidden" name="shop" value="'.$_GET['shop'].'" />';
					}
					echo '<button type="submit" class="button">'.__('Filter', 'woocommerce').'</button>
 ...
 * @return void
 */
function woocommerce_price_filter_custom_init_custom() {
	global $woocommerce;
	...
	if ( is_active_widget( false, false, 'price_filter', true ) && ! is_admin() ) {
		...
		add_filter( 'loop_shop_post_in', 'woocommerce_price_filter_custom' );
	}
}

add_action( 'init', 'woocommerce_price_filter_custom_init_custom' );
 ...
 * @return array
 */
function woocommerce_price_filter_custom($filtered_posts) {
    global $wpdb;
