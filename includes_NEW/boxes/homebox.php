		...
		<div class="homeBox">		
			...
			<div class="recentimage">
					...
					<div class="image">
						...
						<img src="<?php echo get_template_directory_uri() ?>/createthumb.php?path=<?php if (isset($data['box1_image'])) echo $data['box1_image']; else echo get_template_directory_uri().'/images/placeholder-580-small.png';?>&amp;height=150&amp;width=280" alt="<?php echo stripText($data['box1_title']) ?>">
					</div>
				</div>
			...
			<div class="one_third">
				...
				<div class="recentimage">
					<div class="image">
						<div class="loading"></div>
						<img src="<?php echo get_template_directory_uri() ?>/createthumb.php?path=<?php if (isset($data['box2_image'])) echo $data['box2_image']; else echo get_template_directory_uri().'/images/placeholder-580-small.png';?>&amp;height=150&amp;width=280" alt="<?php echo stripText($data['box2_title']) ?>">
					</div>
				</div>
				<div class="recentdescription">
			...
			<a href="<?php if(isset($data['box3_link']))  echo $data['box3_link']?>">
				<div class="recentimage">
					<div class="image">
						<div class="loading"></div>
						<img src="<?php echo get_template_directory_uri() ?>/createthumb.php?path=<?php if (isset($data['box3_image'])) echo $data['box3_image']; else echo get_template_directory_uri().'/images/placeholder-580-small.png';?>&amp;height=150&amp;width=280" alt="<?php echo stripText($data['box3_title']) ?>">
					</div>
				</div>
				<div class="recentdescription">
