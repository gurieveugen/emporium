...
add_action( 'widgets_init', 'WooCommerce_Widget_Cart_Custom_widget' );

function WooCommerce_Widget_Cart_Custom_widget() {
	register_widget( 'WooCommerce_Widget_Cart_Custom' );
}


class WooCommerce_Widget_Cart_Custom extends WP_Widget {
	 ...
	 * @return void
	 */
	function WooCommerce_Widget_Cart_Custom() {

		/* Widget variable settings. */
		$this->woo_widget_cssclass 		= 'widget_shopping_cart_custom';
		...
		$this->woo_widget_name 			= __( 'Emporium Cart', 'woocommerce' );
