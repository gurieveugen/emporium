...
add_action( 'widgets_init', 'WooCommerce_Widget_Recently_Viewed_Custom_widget' );

function WooCommerce_Widget_Recently_Viewed_Custom_widget() {
	register_widget( 'WooCommerce_Widget_Recently_Viewed_Custom' );
}

class WooCommerce_Widget_Recently_Viewed_Custom extends WP_Widget {
	 ...
	 * @return void
	 */
	function WooCommerce_Widget_Recently_Viewed_Custom() {

		/* Widget variable settings. */
		$this->woo_widget_cssclass = 'widget_recently_viewed_products_custom';
		$this->woo_widget_description = __( 'Display a list of recently viewed products.', 'woocommerce' );
		$this->woo_widget_idbase = 'widget_recently_viewed_products_custom';
		$this->woo_widget_name = __('Emporium Recently Viewed Products', 'woocommerce' );
 ...
 * @return void
 */
function woocommerce_track_product_view_custom() {
	global $post, $product;
...
add_action( 'woocommerce_before_single_product', 'woocommerce_track_product_view_custom', 10);