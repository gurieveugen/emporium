...
<div id="mainwrap">
	<div id="main" class="clearfix">		<div class="infotextwrap">			<div class="infotext">				<div class="infotextBorder"></div>					<h1><?php the_title();?></h1>					<div class="homeIcon"><a href="<?php echo home_url(); ?>"></a></div>				<div class="infotextBorder"></div>			</div>		</div>
	...
	<div id="remove" class="portfolioremove">
	    <h2><a class="catlink" href="#filter=*" ><?php echo  stripText($data['translation_all']) ?> <span> </span></a>
	...
	<div class="portfolio">		
		...
		<div id="portitems4">
			...
			<?php portfolio(135,233,4,'port','',getcatslug($port)); ?>
